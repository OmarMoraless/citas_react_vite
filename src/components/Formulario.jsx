...
//Objeto paciente
  ...
  return (
    ...
    <div className='mb-5'>
          <label htmlFor='email' className='block text-gray-700 font-bold uppercase' >Correo Electronico</label>
          <input 
            id='email'
              type="email" 
        ...
        <div className='mb-5'>
          <label htmlFor='fecha' className='block text-gray-700 font-bold uppercase' >Alta</label>
          <input 
            id='fecha'
              type="date" 
        ...
        <input type="submit" name="" id="agregar" className='bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursor-pointer transition-colors' 
